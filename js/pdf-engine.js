 ...
 * FIXED: Preserve all annotations (text, redaction, highlight, image, signature) 
 *        when re-rendering due to zoom/scale change
 */
class PDFEngine {
    constructor(containerId) {
        ...
        // NEW: Callbacks for save/restore annotations
